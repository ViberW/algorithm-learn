 ...
 * @author Viber
 * @version 1.0
 * @apiNote 美团实现 <a href="https://tech.meituan.com/2016/12/02/redblack-tree.html"/>
 * @since 2021/8/25 9:58
 */
public class RBTree<T extends Comparable<T>> {
        ...
        while (dataRoot != null) {
            ...
            if (cmp < 0) {
                ...
                if (dataRoot.getRight() != null) {
                    ...
                    min.setRed(dataRoot.isRed()); //中继节点转变为目标节点的颜色
    ...
    /**
     * find the successor node 寻找中继节点
     */
